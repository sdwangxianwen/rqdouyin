...
@implementation RQPlayerProtocol
...
/** 滑杆 */
- (RQVideoSlider *)videoSlider
{
    if (!_videoSlider) {
        _videoSlider = [[RQVideoSlider alloc]init];
...
#pragma mark - 滑杆
///** 开始拖动事件 */
//- (void)progressSliderTouchBegan:(RQVideoSlider *)slider{
